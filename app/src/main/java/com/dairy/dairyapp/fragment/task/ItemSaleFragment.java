...
import com.dairy.dairyapp.databinding.FragmentItemSaleBinding;
...
public class ItemSaleFragment extends Fragment {
    FragmentItemSaleBinding binding;
    ArrayList arrayList;
    public ItemSaleFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_item_sale, container, false);
