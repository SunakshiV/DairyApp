...
import com.dairy.dairyapp.databinding.FragmentAddAccountBinding;
   ...
   FragmentAddAccountBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_add_account, container, false);
    ...
    class AccountAdapter extends  RecyclerView.Adapter<AccountAdapter.ViewHolder> {
        ...
        public AccountAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
            ...
            return new AddAccountFragment.AccountAdapter.ViewHolder(binding);
        }
