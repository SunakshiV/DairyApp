...
import com.dairy.dairyapp.databinding.FragmentMilkSaleBinding;
...
public class MilkSaleFragment extends Fragment {
 FragmentMilkSaleBinding binding;
    ArrayList arrayList;

    public MilkSaleFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_milk_sale, container, false);
