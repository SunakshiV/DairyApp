...
import com.dairy.dairyapp.databinding.FragmentAdvanceRateBinding;
...
public class AdvanceRateFragment extends Fragment {
    FragmentAdvanceRateBinding binding;
    ArrayList arrayList;

    public AdvanceRateFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_advance_rate, container, false);
