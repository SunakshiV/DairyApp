...
import com.dairy.dairyapp.databinding.FragmentFlateRateBinding;
...
public class FlateRateFragment extends Fragment {
    ArrayList arrayList;
    FragmentFlateRateBinding binding;


    public FlateRateFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_flate_rate, container, false);
